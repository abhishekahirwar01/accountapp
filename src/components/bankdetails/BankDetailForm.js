...
const BankDetailsForm = ({
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top', 'bottom']}>
      ...
      {/* ── Header: back arrow + title (conditionally hidden) ── */}
      {!hideHeader && (
      ...
      >
        ...
        >
          ...
          <View style={styles.field}>
            ...
            <View>
              <TextInput
                style={[styles.inputBox, errors.bankName && styles.inputError]}
                  ...
                  {bankSuggestions.map((item, index) => (
                    <TouchableOpacity
                      ...
                      style={[
                        ...
                        index === bankSuggestions.length - 1 &&
                          styles.suggestionItemLast,
                      ]}
                      onPress={() => handleBankSelect(item)}
                    >
                      <Text style={styles.suggestionBankName}>
                        {item.bank_name}
                      </Text>
          ...
          <View style={styles.row}>
            <View style={[styles.field, styles.half]}>
              ...
              <TextInput
                style={[styles.inputBox, errors.city && styles.inputError]}
                value={formData.city}
            ...
            <View style={[styles.field, styles.half]}>
              <Text style={styles.label}>
                Account No <Text style={styles.req}>*</Text>
              </Text>
              <TextInput
                style={[styles.inputBox, errors.accountNo && styles.inputError]}
          ...
          <View style={styles.row}>
            <View style={[styles.field, styles.half]}>
              ...
              <TextInput
                style={[styles.inputBox, errors.ifscCode && styles.inputError]}
                autoCapitalize="characters"
                value={formData.ifscCode}
                onChangeText={v =>
                  setFormData({ ...formData, ifscCode: v.toUpperCase() })
                }
            ...
            <View style={[styles.field, styles.half]}>
              ...
              <TextInput
                ...
                onChangeText={v =>
                  setFormData({ ...formData, branchAddress: v })
                }
          ...
          <View style={styles.row}>
            ...
            <View style={[styles.field, styles.half]}>
              ...
              <TextInput
                ...
                style={[styles.inputBox, errors.upiMobile && styles.inputError]}
              ...
              />
              {errors.upiMobile && (
                <Text style={styles.error}>{errors.upiMobile}</Text>
              )}
            </View>
          </View>
          ...
          {qrCodePreview || existingQrCode ? (
            <View style={styles.qrCodeContainer}>
              ...
              <View style={styles.qrCodeActions}>
                ...
                >
                  ...
                  <Text
                    style={[styles.qrCodeActionText, styles.qrCodeRemoveText]}
                  >
                    Remove
                  </Text>
                </TouchableOpacity>
            ...
            >
              ...
              <Text style={styles.qrCodeUploadSubtext}>
                Tap to select image
              </Text>
            </TouchableOpacity>
          )}
          ...
          >
            {isSubmitting ? (
              ...
              <Text style={styles.primaryBtnText}>
                {bankDetail ? 'Update Bank Details' : 'Save Bank Details'}
              </Text>
            )}
          </TouchableOpacity>
        </View>
