...
export default function ProfitAndLossTab({
  ...
  const fetchKey = useMemo(() => {
    return `${clientIdForApi || 'no-client'}-${
      companyIdForApi || 'all-companies'
      ...
      <Card style={styles.noClientCard}>
        <View style={styles.noClientContainer}>
          ...
          <Text style={styles.noClientText}>
            Choose a client from the dropdown menu at the top to view the
            analytics dashboard.
          </Text>
        </View>
      </Card>
        ...
        {!loading && !error && (!profitLossData || !profitLossData.success) && (
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptyText}>
              {profitLossData?.message ||
                'No data found for the selected period, client, or company.'}
            </Text>
