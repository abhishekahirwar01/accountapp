...
const CompaniesScreen = () => {
  ...
  const handleEdit = (company) => {
    if (!permissions?.canUpdateCompanies) {
      Alert.alert('Permission Denied', "You don't have permission to update companies.");
      return;
    }
  ...
  const handleDelete = (company) => {
    if (!permissions?.canUpdateCompanies) {
      Alert.alert('Permission Denied', "You don't have permission to delete companies.");
      return;
    }
  ...
  const confirmDelete = async () => {
    ...
    try {
      ...
      setCompanies(prev => prev.filter(company => company._id !== companyToDelete._id));
      Alert.alert('Success', `${companyToDelete.businessName} has been deleted successfully.`);
    } catch (error) {
    ...
    <View style={styles.card}>
      ...
      <View style={styles.contactSection}>
        <View style={styles.contactItem}>
          <View style={[styles.contactIcon, { backgroundColor: 'rgba(0, 122, 255, 0.1)' }]}>
            <User size={12} color="#007AFF" />
          </View>
          <Text style={styles.contactText}>{item.emailId}</Text>
        </View>
        <View style={styles.contactItem}>
          <View style={[styles.contactIcon, { backgroundColor: 'rgba(52, 199, 89, 0.1)' }]}>
  ...
  const renderTableHeader = () => (
    <View style={styles.tableHeader}>
      <View style={styles.tableHeaderCell}><Text style={styles.tableHeaderText}>Company</Text></View>
      <View style={styles.tableHeaderCell}><Text style={styles.tableHeaderText}>Contact</Text></View>
      <View style={styles.tableHeaderCell}><Text style={styles.tableHeaderText}>Reg No.</Text></View>
      <View style={styles.tableHeaderCell}><Text style={styles.tableHeaderText}>GSTIN</Text></View>
      {permissions?.canUpdateCompanies && (
        <View style={styles.tableHeaderCell}><Text style={styles.tableHeaderText}>Actions</Text></View>
      )}
    </View>
  );
  ...
  const renderEmptyState = () => (
    <View style={styles.emptyState}>
      ...
      <Text style={styles.emptyDescription}>Get started by adding your first company.</Text>
      ...
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          <View style={styles.headerTitle}>
            ...
            <Text style={styles.subtitle}>Manage all your business entities in one place.</Text>
          </View>
          <View style={styles.headerActions}>
            <View style={styles.viewToggle}>
              ...
              >
                <LayoutGrid size={16} color={viewMode === 'card' ? 'white' : '#666'} />
              </TouchableOpacity>
              <TouchableOpacity 
                style={[
                  styles.toggleButton, 
              ...
              >
                <List size={16} color={viewMode === 'list' ? 'white' : '#666'} />
              </TouchableOpacity>
            </View>
            {permissions?.canCreateCompanies && (
              <TouchableOpacity style={styles.addCompanyButton} onPress={handleAddNew}>
                <PlusCircle size={16} color="white" />
        ...
        {isLoading ? (
          ...
          <View style={styles.content}>
            ...
            <FlatList
              ...
              renderItem={viewMode === 'card' ? renderCompanyCard : renderCompanyRow}
