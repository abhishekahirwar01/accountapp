      ...
      <head>
        ...
        <style>
          * { margin: 0; padding: 0; box-sizing: border-box; }
          ...
          .amount-words { margin: 8px 0; padding: 6px; background: #f8f9fa; border-radius: 4px; }
          .bank-details { margin: 12px 0; padding: 8px; background: #f8f9fa; border-radius: 4px; }
          .upi-section { margin: 12px 0; padding: 8px; background: #f0f8ff; border-radius: 4px; }
          .qr-section { text-align: center; margin: 8px 0; }
          .qr-image { width: 100px; height: 100px; }
          .upi-text { font-size: 9px; margin: 2px 0; text-align: left; }
          .terms-section { margin: 12px 0; padding: 8px; background: #fff3e0; border-radius: 4px; }
          .footer { margin-top: 16px; text-align: center; font-style: italic; }
        </style>
      </head>
      <body>
        <div class="header">
    ...
    company?.Pincode || ''
        ...
        <div style="margin-top: 8px;">
          ...
          <div class="amount-words">
            ...
            <div>${numberToWords(totalAmount)} ONLY</div>
          </div>
        </div>
        ...
        ${
          ...
          <div class="bank-details">
            <div class="separator">========================BANK DETAILS========================</div>
            ${bank.bankName ? `<div>Bank Name: ${bank.bankName}</div>` : ''}
            ${
              bank.accountNumber
                ? `<div>A/C No: ${bank.accountNumber}</div>`
                : ''
            }
            ${bank.ifscCode ? `<div>IFSC: ${bank.ifscCode}</div>` : ''}
            ${
        ...
        ${
          ...
          <div class="upi-section">
            <div class="separator">========================UPI PAYMENT========================</div>
            ${
              bank?.qrCode
                ? `
